...
class evaluacion:
    ...
    def metricaEvaluacionCohensKappa(self,y_true, y_pred):
        porcentajeEvalaucion = cohen_kappa_score ( y_true, y_pred, weights = 'quadratic' )
        return porcentajeEvalaucion

    def metricaConfusionMatrix(self,y_true, y_pred):
